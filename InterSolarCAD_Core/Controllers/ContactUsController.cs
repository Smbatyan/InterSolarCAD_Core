...
namespace InterSolarCAD_Core.Controllers
{
    ...
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PhoneNumber,Address,Email,AdminEmail")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PhoneNumber,Address,Email,AdminEmail")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
